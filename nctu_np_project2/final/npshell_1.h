            ...
            while( prc<process_count ) {
                ...
                if( strcmp(process[prc][0],"printenv")==0 ) {
                    ...
                    while( fgets(batch_command[batch_count] , 20 , pFile)!=NULL ) {
                        //batch_command[batch_count][strlen(batch_command[batch_count])]='\0';
                        //printf("%d", strlen(batch_command[batch_count]));
                        batch_count++;
                    }
                    //batch_command[batch_count]=NULL;
                    fclose(pFile);
                    batch_command_index = 0;
                    //printf("====\n" );
                    //printf("%s\n", batch_command[0]);
